...
class ColorPalitte: UIView {
    ...
    private func initialize() {
        ...
        let touchGesture = UILongPressGestureRecognizer(target: self, action: #selector(ColorPalitte.touchedColor(_:) ))
